 // Helper: formata em Real
    ...
    // utility to round to 2 decimals with correct cent behavior
    ...
    printBtn.addEventListener('click', ()=>{
      ...
      // abre uma janela com conteúdo simples para impressão
    ...
    // basic HTML escape for print
    function escapeHtml(s){ return String(s).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;'); }

    // initial calc to show example
    calculate();